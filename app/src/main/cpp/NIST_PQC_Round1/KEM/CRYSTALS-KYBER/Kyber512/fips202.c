...
/*************************************************
* Name:        KYBER_KeccakF1600_StatePermute
*
* Description: The Keccak F1600 Permutation
*
* Arguments:   - uint64_t * state: pointer to in/output Keccak state
**************************************************/
void KYBER_KeccakF1600_StatePermute(uint64_t * state)
{
  int round;
                          ...
                          unsigned char p)
{
  ...
  while (mlen >= r)
  {
    ...
    KYBER_KeccakF1600_StatePermute(s);
    mlen -= r;
    m += r;
  }
...
**************************************************/
void KYBER_shake256(unsigned char *output, unsigned long long outlen,
