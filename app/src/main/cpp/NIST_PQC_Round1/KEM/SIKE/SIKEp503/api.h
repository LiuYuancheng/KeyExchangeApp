...
#define SIKE_CRYPTO_SECRETKEYBYTES     434    // MSG_BYTES + SECRETKEY_B_BYTES + CRYPTO_PUBLICKEYBYTES bytes
#define SIKE_CRYPTO_PUBLICKEYBYTES     378
#define SIKE_CRYPTO_BYTES               24
#define SIKE_CRYPTO_CIPHERTEXTBYTES    402    // CRYPTO_PUBLICKEYBYTES + MSG_BYTES bytes

// Change the algorithm name
#define SIKE_CRYPTO_ALGNAME "SIKEp503"
