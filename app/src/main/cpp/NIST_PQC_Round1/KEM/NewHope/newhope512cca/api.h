...
#define NEWHOPE_CRYPTO_SECRETKEYBYTES  NEWHOPE_CCAKEM_SECRETKEYBYTES
#define NEWHOPE_CRYPTO_PUBLICKEYBYTES  NEWHOPE_CCAKEM_PUBLICKEYBYTES
#define NEWHOPE_CRYPTO_CIPHERTEXTBYTES NEWHOPE_CCAKEM_CIPHERTEXTBYTES
#define NEWHOPE_CRYPTO_BYTES           NEWHOPE_SYMBYTES

#if   (NEWHOPE_N == 512)
#define NEWHOPE_CRYPTO_ALGNAME "NewHope-512-CCA"
#elif (NEWHOPE_N == 1024)
#define NEWHOPE_CRYPTO_ALGNAME "NewHope-1024-CCA"
#else
