...
/*************************************************
* Name:        newhope1024cpa_poly_frombytes
* 
...
/*************************************************
* Name:        newhope1024cpa_poly_decompress
* 
...
/*************************************************
* Name:        newhope1024cpa_poly_frommsg
* 
...
void newhope1024cpa_poly_uniform(poly *a, const unsigned char *seed)
{
  ...
  for(i=0;i<NEWHOPE_N/64;i++) /* generate a in blocks of 64 coefficients */
  {
    ...
    NewHope_shake128_absorb(state, extseed, NEWHOPE_SYMBYTES+1);
...
/*************************************************
* Name:        newhope1024cpa_poly_invntt
* 
