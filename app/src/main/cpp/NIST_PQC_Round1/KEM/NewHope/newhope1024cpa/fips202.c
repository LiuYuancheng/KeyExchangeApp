...
static const uint64_t NewHope1024cpa_KeccakF_RoundConstants[NROUNDS] = 
{
...
/*************************************************
* Name:        NewHope_KeccakF1600_StatePermute
* 
* Description: The Keccak F1600 Permutation
*
* Arguments:   - uint64_t * state: pointer to in/output Keccak state
**************************************************/
void NewHope1024cpa_NewHope_KeccakF1600_StatePermute(uint64_t * state)
{
  int round;
        ...
        for( round = 0; round < NROUNDS; round += 2 )
        {
            ...
            BCu = ROL(Asu, 14);
            Eba =   BCa ^((~BCe)&  BCi );
            Eba ^= (uint64_t)NewHope1024cpa_KeccakF_RoundConstants[round];
            Ebe =   BCe ^((~BCi)&  BCo );
            Ebi =   BCi ^((~BCo)&  BCu );
            Ebo =   BCo ^((~BCu)&  BCa );
            Ebu =   BCu ^((~BCa)&  BCe );
            ...
            BCu = ROL(Esu, 14);
            Aba =   BCa ^((~BCe)&  BCi );
            Aba ^= (uint64_t)NewHope1024cpa_KeccakF_RoundConstants[round+1];
            Abe =   BCe ^((~BCi)&  BCo );
            Abi =   BCi ^((~BCo)&  BCu );
            Abo =   BCo ^((~BCu)&  BCa );
            Abu =   BCu ^((~BCa)&  BCe );
                          ...
                          unsigned char p)
{
  ...
  while (mlen >= r) 
  {
    ...
    NewHope1024cpa_NewHope_KeccakF1600_StatePermute(s);
    mlen -= r;
    m += r;
  }
...
/*************************************************
* Name:        NewHope_shake128_squeezeblocks
* 
...
**************************************************/
void NewHope_shake256(unsigned char *output, unsigned long long outlen, 
