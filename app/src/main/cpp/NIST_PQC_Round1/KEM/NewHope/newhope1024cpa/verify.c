...
**************************************************/
int newhope_verify(const unsigned char *a, const unsigned char *b, size_t len)
{
  uint64_t r;
  size_t i;
  r = 0;
...
**************************************************/
void newhope_cmov(unsigned char *r, const unsigned char *x, size_t len, unsigned char b)
{
  size_t i;
