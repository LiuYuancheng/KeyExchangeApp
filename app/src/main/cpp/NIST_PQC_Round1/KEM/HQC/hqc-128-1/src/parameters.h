...
/*
  ...
  #define HQC_SECRET_KEY_BYTES                    Define the size of the secret key in bytes
  #define HQC_PUBLIC_KEY_BYTES                    Define the size of the public key in bytes
  #define HQC_SHARED_SECRET_BYTES                 Define the size of the shared secret in bytes 
  #define HQC_CIPHERTEXT_BYTES                    Define the size of the ciphertext in bytes
...
#define HQC_PARAM_N                             24677
#define HQC_PARAM_N1                            796
#define HQC_PARAM_N2                            31
#define HQC_PARAM_N1N2                          24676
#define HQC_PARAM_T                             15
#define HQC_PARAM_OMEGA                         67
#define HQC_PARAM_OMEGA_E                       77 
#define HQC_PARAM_OMEGA_R                       77
#define HQC_PARAM_DELTA                         60
#define HQC_PARAM_SECURITY                      128
#define HQC_PARAM_DFR_EXP                       128

#define HQC_SECRET_KEY_BYTES                    HQC_CRYPTO_SECRETKEYBYTES
#define HQC_PUBLIC_KEY_BYTES                    HQC_CRYPTO_PUBLICKEYBYTES
#define HQC_SHARED_SECRET_BYTES                 HQC_CRYPTO_BYTES
#define HQC_CIPHERTEXT_BYTES                    HQC_CRYPTO_CIPHERTEXTBYTES

#define HQC_PARAM_POLY                          0x409
#define HQC_PARAM_M                             10
#define HQC_PARAM_GF_MUL_ORDER                  1023
#define HQC_PARAM_G                             541
