 ...
 *  1. It makes a call to the HQC_seedexpander function to obtain a random number \f$ x\f$ in \f$ [0, 2^{24}[ \f$.
 ...
 * array of bytes using the HQC_seedexpander function, and drop the extra bits using a mask.
 *
 * \param[in] v Pointer to an array
 * \param[in] ctx Pointer to the context of the seed expander
 */
...
/**
 * \fn void vect_set_random_from_HQC_randombytes(uint8_t* v)
 * \brief Generates a random vector
 *
 * This function generates a random binary vector. It uses the the HQC_randombytes function.
 *
 * \param[in] v Pointer to an array
 */
