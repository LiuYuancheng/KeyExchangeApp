...
#define LAC_CRYPTO_SECRETKEYBYTES DIM_N+PK_LEN
#define LAC_CRYPTO_PUBLICKEYBYTES PK_LEN
#define LAC_CRYPTO_BYTES MESSAGE_LEN
#define LAC_CRYPTO_CIPHERTEXTBYTES CIPHER_LEN
