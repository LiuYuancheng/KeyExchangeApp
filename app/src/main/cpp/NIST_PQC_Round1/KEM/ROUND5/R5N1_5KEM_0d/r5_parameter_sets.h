...
/** The location of API parameter `ROUND5_CRYPTO_SECRETKEYBYTES` in the parameter set.  */
#define API_SECRET   0
/** The location of API parameter `ROUND5_CRYPTO_PUBLICKEYBYTES` in the parameter set.  */
#define API_PUBLIC   1
/** The location of API parameter `ROUND5_CRYPTO_BYTES` in the parameter set. */
#define API_BYTES    2
/** The location of API parameter `ROUND5_CRYPTO_CIPHERETEXTBYTES` in the parameter set.  */
#define API_CIPHER   3
...
//uint32_t r5_parameter_sets[81][16];

/** The names of the Round5 parameter sets. */
//char *r5_parameter_set_names[81];
