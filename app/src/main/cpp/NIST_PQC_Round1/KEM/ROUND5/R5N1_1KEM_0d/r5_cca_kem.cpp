...
int r5_cca_kem_keygen(unsigned char *pk, unsigned char *sk, const parameters *params) {
    unsigned char *y = (unsigned char *)checked_malloc(params->kappa_bytes);
...
int r5_cca_kem_encapsulate(unsigned char *ct, unsigned char *k, const unsigned char *pk, const parameters *params) {
    ...
    /* Allocate space */
    hash_input = (unsigned char *)checked_malloc((size_t) (params->kappa_bytes + params->pk_size));
    m = (unsigned char *)checked_malloc(params->kappa_bytes);
    L_g_rho = (unsigned char *)checked_malloc(3U * params->kappa_bytes);
    ...
    /* k = H(L, ct) */
    hash_input = (unsigned char *)checked_realloc(hash_input, (size_t) (params->kappa_bytes + params->ct_size + params->kappa_bytes));
...
int r5_cca_kem_decapsulate(unsigned char *k, const unsigned char *ct, const unsigned char *sk, const parameters *params) {
    ...
    /* Allocate space */
    hash_input = (unsigned char *)checked_malloc((size_t) (params->kappa_bytes + params->pk_size));
    m_prime = (unsigned char *)checked_malloc(params->kappa_bytes);
    L_g_rho_prime = (unsigned char *)checked_malloc(3U * params->kappa_bytes);
    ct_prime = (unsigned char *)checked_malloc((size_t) (params->ct_size + params->kappa_bytes));
