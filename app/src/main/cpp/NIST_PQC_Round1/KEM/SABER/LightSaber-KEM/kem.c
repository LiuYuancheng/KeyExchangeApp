...
int SABER_crypto_kem_enc(unsigned char *c, unsigned char *k, const unsigned char *pk)
{
...
int SABER_crypto_kem_dec(unsigned char *k, const unsigned char *c, const unsigned char *sk)
{
  int i, fail;
  ...
  fail = saber_verify(c, cmp, SABER_BYTES_CCA_DEC);
