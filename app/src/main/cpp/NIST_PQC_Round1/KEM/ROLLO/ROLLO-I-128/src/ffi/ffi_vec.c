 ...
 */
void ROLLO_ffi_vec_set(ffi_vec& o, const ffi_vec& v, unsigned int size) {
  o.SetLength(size);
  o = v;
}
 ...
 */
void ROLLO_ffi_vec_set_zero(ffi_vec& o, unsigned int size) {
  o.SetLength(size);
  clear(o);
}
 ...
 */
void ROLLO_ffi_vec_set_random_using_seedexpander(ffi_vec& o, unsigned int size, AES_XOF_struct* ctx) {
	o.SetLength(size);
 ...
 * \param[in] ctx NIST seed expander
 */
void ROLLO_ffi_vec_set_random_full_rank_using_seedexpander(ffi_vec& o, unsigned int size, AES_XOF_struct* ctx) {
 ...
 * \param[in] ctx NIST seed expander
 */
void ROLLO_ffi_vec_set_random_full_rank_with_one_using_seedexpander(ffi_vec& o, unsigned int size, AES_XOF_struct* ctx) {
  o.SetLength(size);
 ...
 * \param[in] ctx NIST seed expander
 */
void ROLLO_ffi_vec_set_random_from_support_using_seedexpander(ffi_vec& o, unsigned int size, const ffi_vec& support, unsigned int rank, AES_XOF_struct* ctx) {
  o.SetLength(size);
 ...
 * \param[in] ctx NIST seed expander
 */
void ROLLO_ffi_vec_set_random_using_rng(ffi_vec& o, unsigned int size) {
	o.SetLength(size);
	for(unsigned int i = 0 ; i < size ; ++i) {
 ...
 * \param[in] size Size of the vector <b>v</b>
 */
void ROLLO_ffi_vec_set_random_full_rank_using_rng(ffi_vec& o, unsigned int size) {
  unsigned int rank_max = ROLLO_FIELD_M < size ? ROLLO_FIELD_M : size;
 ...
 * \param[in] size Size of the vector <b>v</b>
 */
void ROLLO_ffi_vec_set_random_full_rank_with_one_using_rng(ffi_vec& o, unsigned int size) {
  o.SetLength(size);
 ...
 * \param[in] rank Size of the vector support
 */
void ROLLO_ffi_vec_set_random_from_support_using_rng(ffi_vec& o, unsigned int size, const ffi_vec& support, unsigned int rank) {
  o.SetLength(size);
 ...
 */
void ROLLO_ffi_vec_set_coeff(ffi_vec &o, const ffi_elt& e, unsigned int position) {
 ...
 */
void ROLLO_ffi_vec_get_coeff(ffi_elt& o, const ffi_vec& v, unsigned int position) {
	o = coeff(v, position);
}
 ...
 */
int ROLLO_ffi_vec_cmp(const ffi_vec &v1, const ffi_vec &v2) {
  return v1 == v2;
}
 ...
 */
void ROLLO_ffi_vec_echelonize(ffi_vec &o, unsigned int size) {
 ...
 */
unsigned int ROLLO_ffi_vec_gauss(ffi_vec& o, unsigned int size) {
	mat_GF2 matrix;
	vec_vec_GF2 vectors;
 ...
 * \return The rank of the matrix
 */
unsigned int ROLLO_ffi_vec_get_rank(ffi_vec v, unsigned int size) {
 ...
 * \param[in] size Size of the vectors
 */
void ROLLO_ffi_vec_add(ffi_vec &o, const ffi_vec& v1, const ffi_vec& v2, unsigned int size) {
  add(o, v1, v2);
}
 ...
 * \param[in] size Size of the vectors
 */
void ROLLO_ffi_vec_mul(ffi_vec& o, const ffi_vec& v1, const ffi_vec& v2, unsigned int size) {
 ...
 * \param[in] size Size of the vectors
 */
void ROLLO_ffi_vec_scalar_mul(ffi_vec& o, const ffi_vec& v, const ffi_elt& e, unsigned int size) {
  o.SetLength(size);
	for(unsigned int i = 0 ; i < size ; ++i) {
 ...
 */
void ROLLO_ffi_vec_tensor_mul(ffi_vec& o, const ffi_vec& v1, unsigned int size1, const ffi_vec& v2, unsigned int size2) {
 ...
 * \param[in] size2 Size of the vector <b>v2</b>
 */
void ROLLO_ffi_vec_directsum(ffi_vec& o, const ffi_vec& v1, unsigned int size1, const ffi_vec& v2, unsigned int size2) {
	o.SetLength(size1 + size2);
 ...
 * \param[in] size2 Size of the vector <b>v2</b>
 */
void ROLLO_ffi_vec_intersection(ffi_vec& o, unsigned int& size, const ffi_vec& v1, unsigned int size1, const ffi_vec& v2, unsigned int size2) {
	if(size1 == 0 || size2 == 0) {
    size = 0;
 ...
 *
 * This function only copies the bits of <b>v</b> containing information into <b>str2</b>. Indeed, there are only <b>ROLLO_FIELD_M</b> of them while the ffi_vec bit representation is larger due to library storing elements differently.
 *
 * \param[out] str2 Output string
 * \param[in] v Vector to parse
 * \param[in] size Size of the vector
 */
void ROLLO_ffi_vec_to_string(unsigned char* str2, const ffi_vec &v, unsigned int size) {
 ...
 *
 * This function turns the <b>ROLLO_FIELD_M</b> bits of information required to describe <b>v</b> into a ffi_vec bit representation which is larger due to MPFQ storing elements as pointer of unsigned longs.
 *
 * \param[out] v Output vector
 * \param[in] size Size of the vector <b>v</b>
 * \param[in] str2 String to parse
 */
void ROLLO_ffi_vec_from_string(ffi_vec &v, unsigned int size, const unsigned char* str2) {
  unsigned int position = 0;
  unsigned int position1 = 0;
  unsigned int position2 = 0;
 ...
 * \param[in] size Size of the vector <b>v</b>
 */
void ROLLO_ffi_vec_print(const ffi_vec& v, unsigned int size) {
	size = v.rep.length();
	printf("[\n");
	for(unsigned int i = 0 ; i < size ; i++) {
 ...
 */
long ROLLO_ffi_vec_inv(ffi_vec &inv, ffi_vec A) {
  A.normalize();
