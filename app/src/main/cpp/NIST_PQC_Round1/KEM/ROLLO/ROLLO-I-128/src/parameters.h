...
#define ROLLO_PARAM_M 79 /**< Parameter m of the scheme (finite field GF(2^m)) */
...
#define ROLLO_NMODCOEFFS 3 //Number of "1" coefficients in the polynomial defining the ideal
#define ROLLO_MODCOEFFS {0, 5, 47} //List of "1" coefficients in the polynomial defining the ideal
...
#define SHARED_SECRET_BYTES ROLLO_CRYPTO_BYTES
*/
