...
#define NTS_CRYPTO_ALGNAME          "NTS-KEM(13,80)"

#define NTS_CRYPTO_SECRETKEYBYTES   17556
#define NTS_CRYPTO_PUBLICKEYBYTES   929760
#define NTS_CRYPTO_CIPHERTEXTBYTES  162
 ...
 *  given by NTSKEM_NTS_CRYPTO_PUBLICKEYBYTES and NTSKEM_NTS_CRYPTO_SECRETKEYBYTES
 ...
 **/
int NTS_crypto_kem_keypair(unsigned char* pk,
                       unsigned char* sk);
 ...
 *  given by NTSKEM_NTS_CRYPTO_CIPHERTEXTBYTES and NTSKEM_NTS_CRYPTO_BYTES respectively.
 ...
 *          {@see nts_kem_errors.h}
 **/
int NTS_crypto_kem_enc(unsigned char *ct,
                   unsigned char *ss,
 ...
 **/
int NTS_crypto_kem_dec(unsigned char *ss,
