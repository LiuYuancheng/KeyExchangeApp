...
#define RQC_PARAM_M 107 /**< Parameter m of the scheme (finite field GF(q^m)) */
#define RQC_PARAM_K 3 /**< Parameter k of the scheme (code dimension) */
#define RQC_PARAM_N 101 /**< Parameter n of the scheme (code length) */
#define RQC_PARAM_W 6 /**< Parameter omega of the scheme (weight of vectors) */
#define RQC_PARAM_W_R 8 /**< Parameter omega_r of the scheme (weight of vectors) */
#define RQC_PARAM_SECURITY 192 /**< Expected security level */
...
#define RQC_VEC_K_BYTES 41 /**< Number of bytes required to store a vector of size k */
#define RQC_VEC_N_BYTES 1351 /**< Number of bytes required to store a vector of size n */
#define RQC_FFI_ELT_BYTES 14 /**< Number of bytes required to store an element of GF(q^m) */
