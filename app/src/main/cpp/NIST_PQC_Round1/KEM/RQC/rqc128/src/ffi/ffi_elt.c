/**
 * \file ffi_elt.cpp
 * \brief Implementation of ffi_elt.h using the NTL library
 */
...
/** 
 * \fn void ffi_elt_set_random(ffi_elt& o, RQC_AES_XOF_struct* ctx)
 ...
 * \brief This function sets a finite field element to a random value using the NIST RQC_randombytes function
 *
 * This function assumes <b>FIELD_Q</b> = 2.
 *
 * \param[out] o Finite field element
...
/** 
 * \fn void ffi_elt_nth_root(ffi_elt& o, const ffi_elt& e, int n)
...
/** 
 * \fn void ffi_elt_from_string(ffi_elt& o, const unsigned char* str)
 ...
 * \brief This function modifies the NTL RandomWord function in order to use the NIST RQC_randombytes function
 *
 * \return unsigned long 
 */
static unsigned long ntl_random_word_using_rng() {
...
/** 
 * \fn unsigned long ntl_random_word_using_seedexpander(RQC_AES_XOF_struct* ctx)
 ...
 * \brief This function modifies the NTL RandomBits_ulong function in order to use the NIST RQC_randombytes function
 *
 * \param[in] l long
 * \return unsigned long 
 */
...
/** 
 * \fn unsigned long ntl_random_bits_ulong_using_seedexpander(long l, RQC_AES_XOF_struct* ctx)
 ...
 * \brief This function modifies the NTL random function in order to use the NIST RQC_randombytes function
 *
 * \param[in] x GF2X 
 * \param[in] n long
 */
...
/** 
 * \fn void ntl_random_using_seedexpander(GF2X& x, long n, RQC_AES_XOF_struct* ctx)
